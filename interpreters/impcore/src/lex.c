...
/* prototypes of private functions that help with [[getpar]] S184e */
static Parlist reverse_parlist(Parlist p);
/* prototypes of private functions that help with [[getpar]] S185d */
static int  isdelim(char c);
static Name strntoname(const char *s, int n);
/* prototypes of private functions that help with [[getpar]] S185f */
