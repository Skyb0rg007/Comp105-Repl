...
Exp reduce_to_exp(int code, struct Component *components) {
    ...
    /* cases for \impcore's [[reduce_to_exp]] added in exercises S218a */
...
/* arrays of shift functions added to \impcore\ in exercises S218b */
...
struct ParserRow exptable[] = {
  ...
  /* rows added to \impcore's [[exptable]] in exercises S218c */
