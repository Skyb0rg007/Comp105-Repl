...
(* Taken from www/solutions/tuscheme-without-sums.sml *)
...
fun appearsUnprotectedIn (x, e) =
  let fun evaluatesX (LITERAL n) = false
        ...
        | evaluatesX _ = raise Fail "Non-exhaustive"
  in  evaluatesX e
  end
(*#line 11 "tuschemeans.nw"*)
fun typeof (e, Delta, Gamma) =
  let fun literal NIL           = FORALL (["'a"], listtype tvA)
...
(*#line 102 "tuschemeans.nw"*)
        ...
        | ty e = raise Fail ("ty: non-exhaustive" ^ expString e)
  in  ty e
  end
(*#line 114 "tuschemeans.nw"*)
  fun typdef (d, Delta, Gamma) =
  case d
    of VAL (name, e) =>
     ...
     | DEFINE (name, tau, lambda as (formals, body)) =>
         ...
         in  typdef (VALREC (name, funty, LAMBDA lambda), Delta, Gamma)
         end
     | VALREC (name, tau, e) =>
