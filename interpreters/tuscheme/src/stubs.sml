...
exception IO_Io of { name: string }
...
struct
    ...
    fun output1 (() : outstream, c : char) : unit = outputBuf := !outputBuf ^ String.str c
     ...
     *)
    fun filemap () : JsMap.map = prim("execStmtJS", ("return tuscheme_filemap", ""))
