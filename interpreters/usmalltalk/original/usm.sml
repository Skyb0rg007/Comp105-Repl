...
(* abstract syntax and values for \usmalltalk S547a *)
(* support for \usmalltalk\ stack frames S551b *)
...
(* definitions of [[exp]], [[rep]], and [[class]] for \usmalltalk 694a *)
datatype rep
  ...
  | CLASSREP of class
  | METHODV  of method
(* definitions of [[exp]], [[rep]], and [[class]] for \usmalltalk 694c *)
and class 
...
(* definitions of [[exp]], [[rep]], and [[class]] for \usmalltalk 696a *)
and exp = VAR       of name
        | SET       of name * exp
        ...
        | LITERAL   of rep
        | VALUE     of class * rep
(* definitions of [[value]] and [[method]] for \usmalltalk 693 *)
withtype value = class * rep
(* definitions of [[value]] and [[method]] for \usmalltalk 694d *)
and method = { name : name, formals : name list, locals : name list
             , body : exp, superclass : class
             }

(* definition of [[def]] for \usmalltalk 695b *)
...
(* definition of [[unit_test]] for \usmalltalk S547b *)
  ...
  in  case e
        of LITERAL (NUM n) => intString n
         ...
         | BLOCK (xs, es) => bracketSpace ["block", bracketSpace xs,
                                           spaceSep (exps es)]
         | METHOD (xs, [], es) => bracketSpace ["compiled-method", bracketSpace
                                                                             xs,
                                           spaceSep (exps es)]
         | METHOD (xs, ys, es) => bracketSpace ["compiled-method", bracketSpace
                                                                             xs,
...
(* utility functions on \usmalltalk\ classes, methods, and values S550a *)
...
(* support for bootstrapping classes/values used during parsing 706a *)
local 
...
(* support for bootstrapping classes/values used during parsing 706b *)
...
(* support for bootstrapping classes/values used during parsing 706c *)
local
...
val _ = op mkBlock : name list * exp list * value ref env * class * frame ->
                                                                           value
(* support for bootstrapping classes/values used during parsing S557a *)
local
...
(* parsers for single \usmalltalk\ tokens S562a *)
...
(* parsers and [[xdef]] streams for \usmalltalk S561d *)
fun arity name =
...
(* parsers and [[xdef]] streams for \usmalltalk S562b *)
fun isImmutable x =
...
(* parsers and [[xdef]] streams for \usmalltalk S562c *)
val atomicExp =  LITERAL <$> NUM    <$> int
             <|> LITERAL <$> SYM    <$> (sym <|> (quote *> name)
                                             <|> (quote *> (intString <$> int)))
             <|> SUPER              <$  eqx "super" name
             <|> VAR                <$> name
(* parsers and [[xdef]] streams for \usmalltalk S562d *)
(* parsers and parser builders for formal parameters and bindings S375a *)
fun formalsOf what name context = 
  nodups ("formal parameter", context) <$>! @@ (bracket (what, many name))
...
fun method_body exp kind = (curry3 id <$> @@ (formalsIn kind) <*> locals <*>
                                                                       many exp)
...
(* parsers and [[xdef]] streams for \usmalltalk S563a *)
fun exp tokens = (
      atomicExp
...
(* parsers and [[xdef]] streams for \usmalltalk S563b *)
and quotelit tokens = (
         mkSymbol  <$> name
    <|>  mkInteger <$> int
...
(* type declarations for consistency checking *)
val _ = op quotelit : value parser
(* parsers and [[xdef]] streams for \usmalltalk S563c *)
...
(* parsers and [[xdef]] streams for \usmalltalk S563d *)
val method =
...
(* parsers and [[xdef]] streams for \usmalltalk S564a *)
...
(* parsers and [[xdef]] streams for \usmalltalk S564b *)
val xdeftable = 
  let fun bad what =
        "unexpected `(" ^ what ^ "...'; " ^
...
(* parsers and [[xdef]] streams for \usmalltalk S565a *)
...
(* evaluation, testing, and the read-eval-print loop for \usmalltalk S559a *)
...
(* utility functions for building primitives in \usmalltalk S552b *)
...
(* utility functions for building primitives in \usmalltalk S552c *)
...
(* \ml\ functions for [[Object]]'s and [[UndefinedObject]]'s primitives S550d *)
...
(* \ml\ functions for [[Object]]'s and [[UndefinedObject]]'s primitives S551a *)
...
(* \ml\ functions for [[Object]]'s and [[UndefinedObject]]'s primitives S553d *)
fun eqRep ((cx, x), (cy, y)) = 
...
(* \ml\ functions for [[Object]]'s and [[UndefinedObject]]'s primitives S554a *)
...
(* \ml\ functions for [[Object]]'s and [[UndefinedObject]]'s primitives S554b *)
...
val objectMethods =
  internalMethods 
                   [ ";  methods of class [[Object]] 644a "
                   ,
                  "(method ==  (anObject) (primitive sameObject self anObject))"
                   , "(method !== (anObject) ((self == anObject) not))"
                   , ";  methods of class [[Object]] 644b "
                   , "(method =  (anObject) (self == anObject))"
                   , "(method != (anObject) ((self = anObject) not))"
                   , ";  methods of class [[Object]] 663b "
                   , "(method isNil  () false)"
                   , "(method notNil () true)"
                   , ";  methods of class [[Object]] S537a "
                   ,
...
val nilClass = 
  mkClass "UndefinedObject" PENDING objectClass []
    (internalMethods 
                      [ ";  methods of class [[UndefinedObject]] 663a "
                      , "(method isNil  () true)"
                      , "(method notNil () false)"
                      , ";  methods of class [[UndefinedObject]] S538a "
                      , "(method print () ('nil print) self)"
                       ])
(* built-in class [[UndefinedObject]] and value [[nilValue]] 704c *)
val nilValue = 
...
(* \ml\ code for remaining classes' primitives 707a *)
val classPrimitive = unaryPrim (fn (c, rep) => classObject c)
(* \ml\ code for remaining classes' primitives 707b *)
local
...
(* \ml\ code for remaining classes' primitives S554c *)
...
(* \ml\ code for remaining classes' primitives S555g *)
...
fun methodNames (_, CLASS { methods, ... }) = mkArray (map (mkSymbol o fst) (!
                                                                       methods))
(* \ml\ code for remaining classes' primitives S557c *)
...
(* \ml\ code for remaining classes' primitives S557d *)
...
(* \ml\ code for remaining classes' primitives S557e *)
...
val classClass =
  mkClass "Class" PENDING objectClass []
    (internalMethods 
                      [ ";  methods of class [[Class]] 704e "
                      , "(method new () (primitive newUserObject self))"
                      , ";  methods of class [[Class]] S537d "
...
val metaclassClass =
  mkClass "Metaclass" PENDING classClass []
    (internalMethods 
                      [ ";  methods of class [[Metaclass]] 704f "
                      ,
...
(* functions for managing and printing a \usmalltalk\ stack trace S565b *)
local
  (* private state and functions for printing indented traces ((usm)) S565c *)
  fun traceMe xi =
  ...
  (* private state and functions for printing indented traces ((usm)) S565d *)
  val tindent = ref 0
  fun indent 0 = ()
    | indent n = (xprint "  "; indent (n-1))
  (* private state and functions for printing indented traces ((usm)) S565e *)
...
(* private state and functions for maintaining a stack of source-code locations ((usm)) S566a *)
  ...
  fun pop () = case !locationStack
                 of []     => raise InternalError "tracing stack underflows"
                  | h :: t => locationStack := t
in
  (* exposed tracing functions ((usm)) S566b *)
  ...
  fun eprintlnTrace s = ( eprintln s
                        ; showStackTrace (String.isSubstring
                                          ...
                                          orelse String.isSubstring
                                                         "CPU time exhausted" s)
                        ; resetTrace ()
                        )
  (* type declarations for consistency checking *)
...
val primitives = (* primitives for \usmalltalk\ [[::]] S537b *)
              ...
              "subclass failed to implement a method it was responsible for") ::
                 ...
                 (* primitives for \usmalltalk\ [[::]] S537e *)
                 ...
                 (* primitives for \usmalltalk\ [[::]] S538c *)
                 ("value", valuePrim) ::
                 ...
                 (* primitives for \usmalltalk\ [[::]] S556b *)
...
(* helper functions for evaluation 698b *)
...
(* evaluation, [[basis]], and [[processDef]] for \usmalltalk 696b *)
fun eval (e, rho, superclass, F, xi) =
  let val go = applyCheckingOverflow id in go end (* OMIT *)
  let (* definition of function [[evalMethod]] 698a *)
      ...
      (* function [[ev]], the evaluator proper ((usm)) 697a *)
      fun ev (RETURN e) = raise Return { value = ev e, to = F, unwound = [] }
      (* function [[ev]], the evaluator proper ((usm)) 697b *)
...
(* reraise [[Return]], adding [[msgname]], [[class]], and [[loc]] to [[unwound]] S551c *)
      ...
      (* function [[ev]], the evaluator proper ((usm)) 699a *)
        | ev (BLOCK (formals, body)) = mkBlock (formals, body, rho, superclass,
                                                                              F)
      (* function [[ev]], the evaluator proper ((usm)) 699d *)
        | ev (VALUE v) = v
      (* function [[ev]], the evaluator proper ((usm)) 700a *)
        | ev (LITERAL c) = 
            (case c of NUM n => mkInteger n
                     | SYM s => mkSymbol s
                     | _ => raise InternalError "unexpected literal")
      (* function [[ev]], the evaluator proper ((usm)) 700b *)
      ...
      (* function [[ev]], the evaluator proper ((usm)) 700c *)
        | ev (SUPER) = ev (VAR "self")
      (* function [[ev]], the evaluator proper ((usm)) 700d *)
        | ev (BEGIN es) =
            let fun b (e::es, lastval) = b (es, ev e)
                  | b (   [], lastval) = lastval
            in  b (es, nilValue)
            end
      (* function [[ev]], the evaluator proper ((usm)) 701a *)
        | ev (PRIMITIVE (p, args)) =
      ...
      (* function [[ev]], the evaluator proper ((usm)) 701b *)
        | ev (METHOD (xs, ys, es)) =
            mkCompiledMethod { name = "", formals = xs, locals = ys, body =
                                                                        BEGIN es
...
(* evaluation, [[basis]], and [[processDef]] for \usmalltalk 699c *)
...
(* evaluation, [[basis]], and [[processDef]] for \usmalltalk 701c *)
fun evaldef (d, xi) =
...
(* evaluation, [[basis]], and [[processDef]] for \usmalltalk S558b *)
...
(* definition of [[testIsGood]] for \usmalltalk S568b *)
...
(* definitions of [[check{Expect,Assert,Error}Passes]] that call [[printsAs]] S568d *)
...
(* definitions of [[check{Expect,Assert,Error}Passes]] that call [[printsAs]] S569a *)
...
(* definitions of [[check{Expect,Assert,Error}Passes]] that call [[printsAs]] S569b *)
...
(* implementations of \usmalltalk\ primitives and definition of [[initialBasis]] S559b *)
...
(* implementations of \usmalltalk\ primitives and definition of [[initialBasis]] S559c *)
val initialXi =
  let val xdefs =
...
";  predefined uSmalltalk classes and values ((elided)) (THIS CAN'T HAPPEN -- claimed code was not used) "
                       , ";  definition of class [[Boolean]] S538f "
                       , "(class Boolean "
                       , "    [subclass-of Object]"
            ...
            "    (method or:  (alternativeBlock) (self subclassResponsibility))"
                       , ")"
                       , ";  predefined uSmalltalk classes and values 664 "
                       , "(class True "
                       , "  [subclass-of Boolean]"
                       ,
...
";  predefined uSmalltalk classes and values ((elided)) (THIS CAN'T HAPPEN -- claimed code was not used) "
          ...
          "  (method ifFalse:ifTrue: (falseBlock trueBlock) (falseBlock value))"
                   ...
                   "  (method or:  (alternativeBlock) (alternativeBlock value))"
                       , ")"
                       , ";  predefined uSmalltalk classes and values S538b "
                       , "(class Block"
...
"    (method value:value:value:value: (a1 a2 a3 a4) (primitive value self a1 a2 a3 a4))"
                       ...
                       , ")"
                       , ";  predefined uSmalltalk classes and values S555e "
                       , "(class Symbol"
                       , "    [subclass-of Object] ; internal representation"
                       ,
          ...
          "    (class-method new: (aSymbol) (primitive newSymbol self aSymbol))"
                     ...
                     "    (method       print  () (primitive printSymbol self))"
                       ...
                       , ")"
                       , ";  predefined uSmalltalk classes and values S557f "
                       , "(class CompiledMethod"
                       , "  [subclass-of Object]"
                       , ")"
                       , ";  predefined uSmalltalk classes and values S560c "
                       , ";  numeric classes 665a "
                       , "(class Magnitude"
...
";  numeric classes ((elided)) (THIS CAN'T HAPPEN -- claimed code was not used) "
                       , ";  definition of class [[Number]] 672a "
                       , "(class Number"
...
"    (method abs () ((self isNegative) ifTrue:ifFalse: {(self negated)} {self}))"
                 ...
                 "    (method isStrictlyPositive () (self  > (self coerce: 0)))"
                       , ";      other methods of class [[Number]] S542a "
      ...
      "                {(((self raisedToInteger: (anInteger div: 2)) squared) *"
          ...
          "                    (self raisedToInteger: (anInteger mod: 2)))})}))"
                       , ";      other methods of class [[Number]] S542b "
                       ,
    ...
    "        ((self isNegative) ifTrue: {(self error: 'negative-repeat-count)})"
                ...
                "            {(set num (num negated)) (set den (den negated))})"
                       ...
                       , "        self)"
                       , ";      other methods of class [[Fraction]] 674b "
                       ,
         ...
         "    (method setNum:den: (a b) (set num a) (set den b) self) ; private"
                       ...
                       , "        (self signReduce)"
                       , "        (self divReduce))"
                       , ";      other methods of class [[Fraction]] 674c "
                       , "    (method * (f)"
                       ,
"      (((Fraction new) setNum:den: (num * (f num)) (den * (f den))) divReduce))"
                       , ";      other methods of class [[Fraction]] 674d "
...
"            {(Float mant:exp: ((mant * (10 raisedToInteger: (exp - (x-prime exp)))) +"
    ...
    "            {(Fraction num:den: mant (10 raisedToInteger: (exp negated)))}"
      ...
      "            {(Fraction num:den: (mant * (10 raisedToInteger: exp)) 1)}))"
                       , ";      other methods of class [[Float]] S545d "
                  ...
                  "    (method isStrictlyPositive () (mant isStrictlyPositive))"
                       , ";      other methods of class [[Float]] S545e "
                       , "    (method print () "
                 ...
                 "            {(set exp (exp + 1)) (set mant (mant div: 10))}))"
                       , ")"
                       ,
  ";  predefined uSmalltalk classes and values that use numeric literals S538e "
                       , "(val &trace 0)"
                       ,
  ";  predefined uSmalltalk classes and values that use numeric literals S539a "
                       , "(class Char"
                       , "   [subclass-of Object]"
                       , "   [ivars code-point]"
                 ...
                 "   (method init:      (n) (set code-point n) self) ;; private"
                      ...
                      "   (method =          (c) (code-point = (c code-point)))"
                       ...
                       , ")"
                       ,
  ";  predefined uSmalltalk classes and values that use numeric literals S539b "
                       ,
        ...
        "                                    (val right-square (Char new:  93))"
               ...
               "  (method =       (aCollection)  (self subclassResponsibility))"
                       ...
                       , ";    other methods of class [[Collection]] 665d "
                       , "  (method addAll: (aCollection) "
                       , "      (aCollection do: [block (x) (self add: x)])"
                       , "      self)"
                       , ";    other methods of class [[Collection]] 666a "
   ...
   "      (self remove:ifAbsent: oldObject {(self error: 'remove-was-absent)}))"
                       ...
                       , "      self)"
                       , ";    other methods of class [[Collection]] 666b "
       ...
       "      (self do: [block (x) ((x = anObject) ifTrue: {(set n (n + 1))})])"
                       , "      n)"
                       , ";    other methods of class [[Collection]] 666c "
                       , "  (method isEmpty () "
         ...
         "      (self do: [block (x) ((x = anObject) ifTrue: {(return true)})])"
                       , "      false)"
                       , ";    other methods of class [[Collection]] 666d "
  ...
  "     (self do: [block (x) (set aValue (binaryBlock value:value: x aValue))])"
       ...
       "     (self do: [block (x) ((aBlock value: x) ifTrue: {(temp add: x)})])"
                     ...
                     "     (self do: [block (x) (temp add: (aBlock value: x))])"
                       , "     temp)"
                       , ";    other methods of class [[Collection]] 667b "
                       , "  (method species () (self class))"
                       , ";    other methods of class [[Collection]] 667c "
                       , "  (method print ()"
                       , "      (self printName)"
                       , "      (left-round print)"
...
"        (self associationsDo: [block (anAssoc) (aBlock value: (anAssoc value))]))"
                       ,
                       ";      other methods of class [[KeyedCollection]] 668c "
                       , "    (method at: (key)    "
                       ,
...
"        (self associationsDo: [block (x) (((x key) = key) ifTrue: {(return x)})])"
                       , "        (exnBlock value))"
                       ,
                       ";      other methods of class [[KeyedCollection]] 669a "
   ...
   "        (self keyAtValue:ifAbsent: value {(self error: 'value-not-found)}))"
                ...
                "            (((x value) = value) ifTrue: {(return (x key))})])"
                       , "        (exnBlock value))"
                       ,
                       ";      other methods of class [[KeyedCollection]] 669b "
                       , "    (method removeKey: (key)    "
                       ,
        "        (self removeKey:ifAbsent: key {(self error: 'key-not-found)}))"
                       ,
                       ";      other methods of class [[KeyedCollection]] 669c "
                       , "    (method = (collection)"
                       ,
  ...
  "                      (collection at:ifAbsent: (assn key) {(return false)}))"
   ...
   "            {(bodyBlock value: (Association withKey:value: i (self at: i)))"
                       , "             (set i (i + 1))}))"
                       , ")"
                       , ";  collection classes 682a "
                       , ";  classes that define cons cells and sentinels 684a "
                       , "(class Cons"
                       , "    [subclass-of Object]"
                       , "    [ivars car cdr]"
                       , "    (method car ()           car)"
                       ...
                       , "        ((cdr cdr) pred: cdr)"
                       , "        anObject)"
                       , ";      more methods of class [[Cons]] 684c "
                       , "    (method do: (aBlock)"
                       , "        (aBlock value: car)"
                       , "        (cdr do: aBlock))"
                       , ";      more methods of class [[Cons]] 685a "
                       ,
       ...
       "            {(cdr rejectOne:ifAbsent:withPred: aBlock exnBlock self)}))"
                       , ")"
                       , ";  classes that define cons cells and sentinels 685c "
                       , "(class ListSentinel"
                       , "    [subclass-of Cons]"
                       , "    [ivars pred]"
                      ...
                      ";      iterating methods of class [[ListSentinel]] 684d "
                       ...
                       ,
                      ";      iterating methods of class [[ListSentinel]] 685b "
                       ,
               "    (method rejectOne:ifAbsent:withPred: (aBlock exnBlock pred)"
                       , "        (exnBlock value)))"
                       , "(class List"
   ...
   "    (class-method new ()        ((super new) sentinel: (ListSentinel new)))"
      ...
      "    (method addFirst: (item)   (sentinel insertAfter: item)        self)"
                       ...
                       , "            exnBlock"
                       , "            sentinel))"
                       , ";      other methods of class [[List]] 683b "
                       ,
           "    (method removeKey:ifAbsent: (n exnBlock) (self leftAsExercise))"
                       , ";      other methods of class [[List]] 683c "
                       , "    (method firstKey () 0)"
      ...
      "   (method setKey:value: (x y) (set key x) (set value y) self) ; private"
          ...
          "    (method initDictionary () (set table (List new)) self) ; private"
            ...
            "             {(table add: (Association withKey:value: key value))}"
                       ...
                       , "        self)"
                       , ";      other methods of class [[Dictionary]] S540c "
...
"    (method at:put:    (key value) (primitive arrayUpdate self key value) self)"
  ...
  "    (method fixedSizeError      ()    (self error: 'arrays-have-fixed-size))"
                       , ";      other methods of class [[Array]] 670c "
                       , "    (method firstKey () 0)"
                       , "    (method lastKey  () ((self size) - 1))"
                       ...
                       , "            (set index (index + 1))}))"
                       ,
                  ";      other methods of class [[Array]] ((prototype)) S541d "
                       ,
...
(* implementations of \usmalltalk\ primitives and definition of [[initialBasis]] S560a *)
local 
...
(* implementations of \usmalltalk\ primitives and definition of [[initialBasis]] S560b *)
val _ =
...
(* implementations of \usmalltalk\ primitives and definition of [[initialBasis]] S560d *)
...
(* function [[runAs]] for \usmalltalk, which prints stack traces S568a *)
